                        ...
                        <tbody className="divide-y divide-white/5">
                            {zones.map((zone) => (
                                <tr key={zone.id} className="hover:bg-white/[0.02] transition-colors">
                                    <td className="glass-table-td text-sm font-bold text-white whitespace-nowrap">{zone.name}</td>
                                    <td className="glass-table-td text-sm text-gray-400 min-w-[200px]">{zone.description || '-'}</td>
                                    <td className="glass-table-td text-sm text-gray-400 whitespace-nowrap">
                                        {new Date(zone.createdAt).toLocaleDateString('id-ID', { year: 'numeric', month: 'short', day: 'numeric' })}
                                    </td>
                                    <td className="glass-table-td text-right text-sm font-medium whitespace-nowrap">
